...
/**
 * The MovieRecommendationsWithJoin is a Spark program to implement a basic movie recommendation engine using "join" for a given set of rated movies.
 *
...
public class MovieRecommendationsWithJoin {
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: MovieRecommendationsWithJoin  <input-users-ratings> <output>");
            System.exit(1);
        }
        String usersRatingsInputFile = args[0];
        System.out.println("usersRatingsInputFile=" + usersRatingsInputFile);
        String outputPath = PathAppendUtil.pathAppend(args[1], MovieRecommendationsWithJoin.class.getSimpleName());
        //STEP-2: create a Spark's context object
        JavaSparkContext ctx = SparkUtil.createJavaSparkLocalContext(MovieRecommendationsWithJoin.class.getSimpleName());
        ...
        JavaPairRDD<Tuple2<String, String>, Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer>>
            moviePairs = filteredRDD
            .mapToPair(new PairFunction<Tuple2<String, Tuple2<Tuple3<String, Integer, Integer>, Tuple3<String, Integer, Integer>>>,       // T
