package com.undergrowth.dataalgorithm.movierecom;

//STEP-0: import required classes and interfaces

import com.undergrowth.dataalgorithm.Combination;
import com.undergrowth.dataalgorithm.PathAppendUtil;
import com.undergrowth.dataalgorithm.SparkUtil;
import com.undergrowth.dataalgorithm.Tuple3;
import com.undergrowth.dataalgorithm.Tuple7;
import com.undergrowth.dataalgorithm.secondsort.SecondarySortUsingCombineByKey;
...
/**
 * The MovieRecommendations is a Spark program to implement a basic movie recommendation engine for a given set of rated movies.
 *
 * @author Mahmoud Parsian
 */
public class MovieRecommendations {
    public static void main(String[] args) throws Exception {
        // data/movies.txt dataout/
        //STEP-1: handle input parameters
        if (args.length < 2) {
            System.err.println("Usage: MovieRecommendations <input-users-ratings> <output>");
            System.exit(1);
        }
        String usersRatingsInputFile = args[0];
        System.out.println("usersRatingsInputFile=" + usersRatingsInputFile);
        String outputPath = PathAppendUtil.pathAppend(args[1],MovieRecommendations.class.getSimpleName()) ;

        //STEP-2: create a Spark's context object
        JavaSparkContext ctx = SparkUtil.createJavaSparkLocalContext(MovieRecommendations.class.getSimpleName());
        ...
        JavaPairRDD<String, Tuple2<String, Integer>> moviesRDD =
            //                               T       K       V
            usersRatings.mapToPair((PairFunction<String, String, Tuple2<String, Integer>>) s -> {
        ...
        JavaPairRDD<String, Tuple3<String, Integer, Integer>> usersRDD =
            ...
            moviesGrouped.flatMapToPair(
                (PairFlatMapFunction<Tuple2<String, Iterable<Tuple2<String, Integer>>>, String, Tuple3<String, Integer, Integer>>) s -> {
...
// V
        JavaPairRDD<Tuple2<String, String>, Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer>>
            //                                T       K       V
            moviePairs = groupedbyUser.flatMapToPair(
            (PairFlatMapFunction<Tuple2<String, Iterable<Tuple3<String, Integer, Integer>>>, Tuple2<String, String>, Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer>>) s -> {
                String user = s._1;
        ...
        corr.saveAsTextFile(outputPath);
        System.exit(0);
    }
