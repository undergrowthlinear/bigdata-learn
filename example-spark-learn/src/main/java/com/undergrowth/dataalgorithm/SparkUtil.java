...
public class SparkUtil {
    ...
    */
    ...
    public static JavaSparkContext createJavaSparkLocalContext(String applicationName)
        throws Exception {
        SparkConf conf = new SparkConf().setAppName(applicationName).setMaster("local[2]");
        JavaSparkContext ctx = new JavaSparkContext(conf);
        return ctx;
    }
