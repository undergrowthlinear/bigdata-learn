 ...
 */
package com.undergrowth.starter;

import org.apache.log4j.Logger;
import org.apache.storm.Config;
import com.undergrowth.starter.bolt.RollingCountBolt;
import com.undergrowth.starter.bolt.TotalRankingsBolt;
import com.undergrowth.starter.util.StormRunner;
import org.apache.storm.testing.TestWordSpout;
import org.apache.storm.topology.TopologyBuilder;
import org.apache.storm.tuple.Fields;
import com.undergrowth.starter.bolt.IntermediateRankingsBolt;
import com.undergrowth.starter.bolt.RollingCountAggBolt;
...
public class SkewedRollingTopWords {
   ...
   * $ storm jar storm-starter-jar-with-dependencies.jar org.apache.storm.RollingTopWords
   *
   * # Runs in local mode (LocalCluster), with topology name "foobar"
   * $ storm jar storm-starter-jar-with-dependencies.jar org.apache.storm.RollingTopWords foobar
   *
   * # Runs in local mode (LocalCluster), with topology name "foobar"
   * $ storm jar storm-starter-jar-with-dependencies.jar org.apache.storm.RollingTopWords foobar local
   *
   * # Runs in remote/cluster mode, with topology name "production-topology"
   * $ storm jar storm-starter-jar-with-dependencies.jar org.apache.storm.RollingTopWords production-topology remote
   * ```
   *
