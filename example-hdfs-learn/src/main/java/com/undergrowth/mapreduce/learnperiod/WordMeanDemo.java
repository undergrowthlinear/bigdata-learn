...
public class WordMeanDemo extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        // E:\java_other\bigdata\hadoop\test_some\test_word.txt E:\java_other\bigdata\hadoop\test_some\mean_output
        ToolRunner.run(new Configuration(), new WordMeanDemo(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(WordMeanDemo.class);
