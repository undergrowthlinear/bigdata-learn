...
package com.undergrowth.mapreduce.learnperiod;
 ...
 * </configuration>}</pre>
 * 
 * Equivalently, {@link RandomTextWriterDemo} also supports all the above options
 ...
 */
public class RandomTextWriterDemo extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {    
    ...
    job.setJarByClass(RandomTextWriterDemo.class);
  ...
  public static void main(String[] args) throws Exception {
    // E:\java_other\bigdata\hadoop\test_some\random_text_writer_output
    int res = ToolRunner.run(new Configuration(), new RandomTextWriterDemo(), args);
    System.exit(res);
  }
