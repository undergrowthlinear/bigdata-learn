 ...
 */
public class BaileyBorweinPlouffeDemo extends Configured implements Tool {
  ...
  private static final String NAME = "mapreduce." +
      BaileyBorweinPlouffeDemo.class.getSimpleName();
  ...
  private static final Log LOG = LogFactory.getLog(BaileyBorweinPlouffeDemo.class);
  ...
  private static Job createJob(String name, Configuration conf
    ...
    job.setJarByClass(BaileyBorweinPlouffeDemo.class);
