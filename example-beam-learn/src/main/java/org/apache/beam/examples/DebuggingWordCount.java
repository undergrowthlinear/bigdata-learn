 ...
 *
 * <p>This class, {@link DebuggingWordCount}, is the third in a series of four successively more detailed 'word count' examples. You may first want to
 * take a look at {@link MinimalWordCount} and {@link WordCount}. After you've looked at this example, then see the {@link WindowedWordCount}
 * pipeline, for introduction of additional concepts.
 *
 * <p>Basic concepts, also in the MinimalWordCount and WordCount examples: Reading text files; counting a PCollection; executing a Pipeline both
 * locally and using a selected runner; defining DoFns.
 *
 * <p>New Concepts:
 *
 * <pre>
 ...
 * }</pre>
 *
 * <p>The input file defaults to a public data set containing the text of of King Lear, by William Shakespeare. You can override it and choose your
 * own input with {@code --inputFile}.
 */
public class DebuggingWordCount {
    ...
    public static class FilterTextFn extends DoFn<KV<String, Long>, KV<String, Long>> {
        /**
         * Concept #1: The logger below uses the fully qualified class name of FilterTextFn as the logger. Depending on your SLF4J configuration, log
         * statements will likely be qualified by this name.
         *
         * <p>Note that this is entirely standard SLF4J usage. Some runners may provide a default SLF4J configuration that is most appropriate for
         * their logging integration.
         */
        ...
        /**
         * Concept #2: A custom metric can track values in your pipeline as it runs. Each runner provides varying levels of support for metrics, and
         * may expose them in a dashboard, etc.
         */
     ...
     *
     * <p>Inherits standard configuration options and all options defined in {@link WordCount.WordCountOptions}.
     */
    public interface WordCountOptions extends WordCount.WordCountOptions {
        ...
        @Default.String("Repository|Spark")
     ...
     */
        ...
        List<KV<String, Long>> expectedResults =
            Arrays.asList(KV.of("Repository", 1L), KV.of("Spark", 1L));
